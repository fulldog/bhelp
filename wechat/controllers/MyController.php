...
class MyController extends WController
{
    ...
    function beforeAction($action)
    {
        ...
        if (!$this->vipEnable && !(\Yii::$app->controller->id == 'index' && in_array(\Yii::$app->controller->action->id, $white['action']))
            || \Yii::$app->controller->id == 'order' && in_array(\Yii::$app->controller->action->id, $white['action'])) {
